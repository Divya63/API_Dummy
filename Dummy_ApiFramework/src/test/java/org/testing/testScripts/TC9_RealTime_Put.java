...
public class TC9_RealTime_Put 
{
	...
	{
		Properties pr = LoadFile.loadproperties("../Dummy_ApiFramework/URI.properties");
		String jsonbody = LoadJsonFIle.jsonData("../Dummy_ApiFramework/src/test/java/org/testing/resources/Update_Dummy.json");
